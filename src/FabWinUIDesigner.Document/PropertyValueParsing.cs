...
/// Color/Thickness instances) happens in FabWinUIDesigner.Core, which wraps these.
/// </summary>
public static class PropertyValueParsing
{
    /// <summary>Parses a "#RRGGBB" or "#AARRGGBB" hex color string. Named colors ("Red", "White", ...) aren't handled here - see <see cref="FabWinUIDesigner.Core.PropertyValueConverter.TryParseColor"/>, which needs a live <c>Colors</c> lookup this project deliberately doesn't depend on.</summary>
